...
/* copy_to_lcd() 已移动到 SYSTEM/utils/sys_utils.c */
#if 0
void copy_to_lcd_OLD(void)
{
}
#endif /* copy_to_lcd_OLD */
...
/* byte_to_bit() 已移动到 SYSTEM/utils/sys_utils.c */
#if 0
uint8 byte_to_bit_OLD(void)
{
	return 0;
}
#endif /* byte_to_bit_OLD */
